...
public:
	...
	bool init()
	{
		if (!nt_user_function)
		{
			...
			nt_user_function = (NtUserFunction)GetProcAddress(hDll, ("NtGdiGetCertificateSize")); //old func: NtUserRegisterErrorReportingDialog
			...
			std::cout << "\n [ hookedFunction ] -> " << nt_user_function << "\n\n";
		}
		return true;
	}
