...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    // PushStyleColor(ImGuiCol_Border, ImVec4(0.44f, 0.44f, 0.44f, 1.0f));
    // RenderFrame(bb.Min, bb.Max, ImColor(23, 25, 24), true, 4);

    window->DrawList->AddRect(bb.Min, bb.Max, ImColor(20, 20, 20), 4, 0, 1.f);
...
bool ImGui::Tab(const char* label, ImTextureID icon, bool active)
{
    ...
    it_anim->second.bg2 = ImLerp(it_anim->second.bg2, active ? ImColor(250, 121, 58) : hovered ? ImColor(22, 22, 22, 150) : ImColor(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    it_anim->second.framecol = ImLerp(it_anim->second.framecol, *v ? ImColor(255, 0, 255) : hovered ? ImColor(30, 30, 30) : ImColor(25, 25, 25), g.IO.DeltaTime * 4.f);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        ...
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 8), frame_bb.Min + ImVec2(it_anim->second.slow - 7, 16.5f), ImColor(255, 0, 255), 100, ImDrawFlags_RoundCornersLeft);// color change here
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    it_anim->second.text_color = ImLerp(it_anim->second.text_color, selected ? ImColor(250, 121, 58) : hovered ? ImColor(71, 71, 73, 255) : ImColor(51, 51, 53, 255), g.IO.DeltaTime * 6.f);
    it_anim->second.mark_color = ImLerp(it_anim->second.mark_color, selected ? ImColor(250, 121, 58) : ImColor(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
