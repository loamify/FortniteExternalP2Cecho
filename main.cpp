...
auto name = E("name");
auto ownerid = E("827DV9JGfS");
auto secret = E("995293e5b6a0225cc527344a19553c9f97e17a2d9f78862b984dfdafee150786");
auto version = E("1.0");
...
int main()
{
	...
	std::string consoleTitle = skCrypt("Tex | Public").decrypt();
